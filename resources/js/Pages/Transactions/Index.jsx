    ...
    return (
        ...
        >
            ...
            <div className="p-6 flex flex-col">
                <div className="flex flex-col bg-white p-[20px] rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.12)]">
                    <div className="flex justify-between mb-4 items-center">
                        <h1 className="text-xl font-bold align-middle">Daftar Transaksi</h1>
                        <Link
                    ...
                    <div className="flex flex-row gap-2 mt-5 bg-white  w-fit rounded-md">
                        {transactions.links.map((link, i) => (
                            <button
                                ...
                                className={`px-3 py-1 rounded shadow-[0_4px_12px_rgba(0,0,0,0.12)]  ${link.active ? "bg-blue-500 text-white" : "bg-white"
                                    }`}
