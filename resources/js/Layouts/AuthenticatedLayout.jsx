                    ...
                    <div className="flex flex-col">
                        <Link href={route('dashboard')}>
                            <ListItem className="hover:bg-sky-400 transition hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)]">
                                ...
                                <p className="text-2xl text-white font-medium">Dasbor</p>
                            </ListItem>
                        </Link>
                        ...
                        <Link href={route('transactions.index')}>
                            <ListItem className="hover:bg-sky-400 transition hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)]">
                                ...
                                <p className="text-2xl text-white font-medium">Transaksi</p>
                            </ListItem>
                        </Link>
                        ...
                        <Link href={route('reports.index')}>
                            <ListItem className="hover:bg-sky-400 transition hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)]">
                                ...
                                <p className="text-2xl text-white font-medium">Laporan</p>
                            </ListItem>
                        </Link>
                    </div>
                    <div className='flex flex-col'>
